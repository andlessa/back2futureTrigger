...
V_88 = Vertex(name = 'V_88',
              particles = [ P.P__tilde__chi0bar, P.P__tilde__chi0, P.<>CreateObjectParticleName[PartNameMG[Phibar]], P.<>CreateObjectParticleName[PartNameMG[Phi]] ],
              color = [ '1' ],
              lorentz = [ L.FFSS1 ],
              couplings = {(0,0):C.GC_140})

V_89 = Vertex(name = 'V_89',
              particles = [ P.P__tilde__chi1bar, P.P__tilde__chi0, P.<>CreateObjectParticleName[PartNameMG[Phibar]], P.<>CreateObjectParticleName[PartNameMG[Phi]] ],
              color = [ '1' ],
              lorentz = [ L.FFSS1 ],
              couplings = {(0,0):C.GC_141})

V_90 = Vertex(name = 'V_90',
              particles = [ P.P__tilde__chi0bar, P.P__tilde__chi1, P.<>CreateObjectParticleName[PartNameMG[Phibar]], P.<>CreateObjectParticleName[PartNameMG[Phi]] ],
              color = [ '1' ],
              lorentz = [ L.FFSS1 ],
              couplings = {(0,0):C.GC_141})

V_91 = Vertex(name = 'V_91',
              particles = [ P.P__tilde__chi1bar, P.P__tilde__chi1, P.<>CreateObjectParticleName[PartNameMG[Phibar]], P.<>CreateObjectParticleName[PartNameMG[Phi]] ],
              color = [ '1' ],
              lorentz = [ L.FFSS1 ],
...
V_195 = Vertex(name = 'V_195',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV4, L.FFV5 ],
               couplings = {(0,0):C.GC_75,(0,1):C.GC_72})
...
V_198 = Vertex(name = 'V_198',
               ...
               couplings = {(0,1):C.GC_32,(0,0):C.GC_31})
...
V_201 = Vertex(name = 'V_201',
               ...
               color = [ '1' ],
               lorentz = [ L.FFV2, L.FFV3 ],
               couplings = {(0,1):C.GC_36,(0,0):C.GC_35})
