...
Decay_P__tilde__chi0 = Decay(name = 'Decay_P__tilde__chi0',
                             ...
                             partial_widths = {(P.a,P.P__tilde__chi1):'((M0**2 - M1**2)*((16*Caxx1x2**2*M0**4)/LambdaUV**2 - (32*Caxx1x2**2*M0**2*M1**2)/LambdaUV**2 + (16*Caxx1x2**2*M1**4)/LambdaUV**2))/(32.*cmath.pi*abs(M0)**3)',
                                               (P.H,P.P__tilde__chi1):'((M0**2*sina**2*ychi1x2**2 + 2*M0*M1*sina**2*ychi1x2**2 + M1**2*sina**2*ychi1x2**2 - MH**2*sina**2*ychi1x2**2)*cmath.sqrt(M0**4 - 2*M0**2*M1**2 + M1**4 - 2*M0**2*MH**2 - 2*M1**2*MH**2 + MH**4))/(32.*cmath.pi*abs(M0)**3)',
                                               (P.Sd,P.P__tilde__chi1):'((cosa**2*M0**2*ychi1x2**2 + 2*cosa**2*M0*M1*ychi1x2**2 + cosa**2*M1**2*ychi1x2**2 - cosa**2*MSd**2*ychi1x2**2)*cmath.sqrt(M0**4 - 2*M0**2*M1**2 + M1**4 - 2*M0**2*MSd**2 - 2*M1**2*MSd**2 + MSd**4))/(32.*cmath.pi*abs(M0)**3)'})
...
Decay_P__tilde__chi1 = Decay(name = 'Decay_P__tilde__chi1',
                             ...
                             partial_widths = {(P.a,P.P__tilde__chi0):'((-M0**2 + M1**2)*((16*Caxx1x2**2*M0**4)/LambdaUV**2 - (32*Caxx1x2**2*M0**2*M1**2)/LambdaUV**2 + (16*Caxx1x2**2*M1**4)/LambdaUV**2))/(32.*cmath.pi*abs(M1)**3)',
                                               (P.H,P.P__tilde__chi0):'((M0**2*sina**2*ychi1x2**2 + 2*M0*M1*sina**2*ychi1x2**2 + M1**2*sina**2*ychi1x2**2 - MH**2*sina**2*ychi1x2**2)*cmath.sqrt(M0**4 - 2*M0**2*M1**2 + M1**4 - 2*M0**2*MH**2 - 2*M1**2*MH**2 + MH**4))/(32.*cmath.pi*abs(M1)**3)',
                                               (P.Sd,P.P__tilde__chi0):'((cosa**2*M0**2*ychi1x2**2 + 2*cosa**2*M0*M1*ychi1x2**2 + cosa**2*M1**2*ychi1x2**2 - cosa**2*MSd**2*ychi1x2**2)*cmath.sqrt(M0**4 - 2*M0**2*M1**2 + M1**4 - 2*M0**2*MSd**2 - 2*M1**2*MSd**2 + MSd**4))/(32.*cmath.pi*abs(M1)**3)'})

Decay_H = Decay(name = 'Decay_H',
                particle = P.H,
                partial_widths = {(P.b,P.b__tilde__):'((-12*cosa**2*MB**2*yb**2 + 3*cosa**2*MH**2*yb**2)*cmath.sqrt(-4*MB**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  (P.P__tilde__chi0,P.P__tilde__chi0bar):'((-4*M0**2*sina**2*ychi1x1**2 + MH**2*sina**2*ychi1x1**2)*cmath.sqrt(-4*M0**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  (P.P__tilde__chi0,P.P__tilde__chi1bar):'((-(M0**2*sina**2*ychi1x2**2) - 2*M0*M1*sina**2*ychi1x2**2 - M1**2*sina**2*ychi1x2**2 + MH**2*sina**2*ychi1x2**2)*cmath.sqrt(M0**4 - 2*M0**2*M1**2 + M1**4 - 2*M0**2*MH**2 - 2*M1**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  (P.P__tilde__chi1,P.P__tilde__chi0bar):'((-(M0**2*sina**2*ychi1x2**2) - 2*M0*M1*sina**2*ychi1x2**2 - M1**2*sina**2*ychi1x2**2 + MH**2*sina**2*ychi1x2**2)*cmath.sqrt(M0**4 - 2*M0**2*M1**2 + M1**4 - 2*M0**2*MH**2 - 2*M1**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  ...
                                  (P.Sd,P.Sd):'((cosa**6*lam3**2*vev**2 + 12*cosa**4*lam1*lam3*sina**2*vev**2 - 4*cosa**4*lam3**2*sina**2*vev**2 + 36*cosa**2*lam1**2*sina**4*vev**2 - 24*cosa**2*lam1*lam3*sina**4*vev**2 + 4*cosa**2*lam3**2*sina**4*vev**2 - 12*cosa**5*lam2*lam3*sina*vev*vevD + 4*cosa**5*lam3**2*sina*vev*vevD - 72*cosa**3*lam1*lam2*sina**3*vev*vevD + 24*cosa**3*lam1*lam3*sina**3*vev*vevD + 24*cosa**3*lam2*lam3*sina**3*vev*vevD - 10*cosa**3*lam3**2*sina**3*vev*vevD - 12*cosa*lam1*lam3*sina**5*vev*vevD + 4*cosa*lam3**2*sina**5*vev*vevD + 36*cosa**4*lam2**2*sina**2*vevD**2 - 24*cosa**4*lam2*lam3*sina**2*vevD**2 + 4*cosa**4*lam3**2*sina**2*vevD**2 + 12*cosa**2*lam2*lam3*sina**4*vevD**2 - 4*cosa**2*lam3**2*sina**4*vevD**2 + lam3**2*sina**6*vevD**2)*cmath.sqrt(MH**4 - 4*MH**2*MSd**2))/(32.*cmath.pi*abs(MH)**3)',
...
Decay_Sd = Decay(name = 'Decay_Sd',
                 ...
                 partial_widths = {(P.b,P.b__tilde__):'((-12*MB**2*sina**2*yb**2 + 3*MSd**2*sina**2*yb**2)*cmath.sqrt(-4*MB**2*MSd**2 + MSd**4))/(16.*cmath.pi*abs(MSd)**3)',
                                   (P.P__tilde__chi0,P.P__tilde__chi0bar):'((-4*cosa**2*M0**2*ychi1x1**2 + cosa**2*MSd**2*ychi1x1**2)*cmath.sqrt(-4*M0**2*MSd**2 + MSd**4))/(16.*cmath.pi*abs(MSd)**3)',
                                   (P.P__tilde__chi0,P.P__tilde__chi1bar):'((-(cosa**2*M0**2*ychi1x2**2) - 2*cosa**2*M0*M1*ychi1x2**2 - cosa**2*M1**2*ychi1x2**2 + cosa**2*MSd**2*ychi1x2**2)*cmath.sqrt(M0**4 - 2*M0**2*M1**2 + M1**4 - 2*M0**2*MSd**2 - 2*M1**2*MSd**2 + MSd**4))/(16.*cmath.pi*abs(MSd)**3)',
                                   (P.P__tilde__chi1,P.P__tilde__chi0bar):'((-(cosa**2*M0**2*ychi1x2**2) - 2*cosa**2*M0*M1*ychi1x2**2 - cosa**2*M1**2*ychi1x2**2 + cosa**2*MSd**2*ychi1x2**2)*cmath.sqrt(M0**4 - 2*M0**2*M1**2 + M1**4 - 2*M0**2*MSd**2 - 2*M1**2*MSd**2 + MSd**4))/(16.*cmath.pi*abs(MSd)**3)',
                                   (P.P__tilde__chi1,P.P__tilde__chi1bar):'((-4*cosa**2*M1**2*ychi2x2**2 + cosa**2*MSd**2*ychi2x2**2)*cmath.sqrt(-4*M1**2*MSd**2 + MSd**4))/(16.*cmath.pi*abs(MSd)**3)',
                                   (P.g,P.g):'(GGS**2*MSd**6)/(8.*cmath.pi*abs(MSd)**3)',
                                   (P.H,P.H):'((36*cosa**4*lam1**2*sina**2*vev**2 - 24*cosa**4*lam1*lam3*sina**2*vev**2 + 4*cosa**4*lam3**2*sina**2*vev**2 + 12*cosa**2*lam1*lam3*sina**4*vev**2 - 4*cosa**2*lam3**2*sina**4*vev**2 + lam3**2*sina**6*vev**2 + 12*cosa**5*lam1*lam3*sina*vev*vevD - 4*cosa**5*lam3**2*sina*vev*vevD + 72*cosa**3*lam1*lam2*sina**3*vev*vevD - 24*cosa**3*lam1*lam3*sina**3*vev*vevD - 24*cosa**3*lam2*lam3*sina**3*vev*vevD + 10*cosa**3*lam3**2*sina**3*vev*vevD + 12*cosa*lam2*lam3*sina**5*vev*vevD - 4*cosa*lam3**2*sina**5*vev*vevD + cosa**6*lam3**2*vevD**2 + 12*cosa**4*lam2*lam3*sina**2*vevD**2 - 4*cosa**4*lam3**2*sina**2*vevD**2 + 36*cosa**2*lam2**2*sina**4*vevD**2 - 24*cosa**2*lam2*lam3*sina**4*vevD**2 + 4*cosa**2*lam3**2*sina**4*vevD**2)*cmath.sqrt(-4*MH**2*MSd**2 + MSd**4))/(32.*cmath.pi*abs(MSd)**3)',
