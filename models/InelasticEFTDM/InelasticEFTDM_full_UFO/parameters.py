...
Chxx22 = Parameter(name = 'Chxx22',
                   nature = 'external',
                   type = 'real',
                   value = 0.1,
                   texname = 'C_{\\text{hxx22}}',
                   lhablock = 'NPINPUTS',
                   lhacode = [ 2 ])

Chxx11 = Parameter(name = 'Chxx11',
                   nature = 'external',
                   type = 'real',
                   value = 0.1,
                   texname = 'C_{\\text{hxx11}}',
                   lhablock = 'NPINPUTS',
                   lhacode = [ 3 ])

Chxx00 = Parameter(name = 'Chxx00',
                   nature = 'external',
                   type = 'real',
                   value = 0.1,
                   texname = 'C_{\\text{hxx00}}',
                   lhablock = 'NPINPUTS',
                   lhacode = [ 4 ])
...
ychi22 = Parameter(name = 'ychi22',
                   nature = 'external',
                   type = 'real',
                   value = 1.,
                   texname = 'y_{\\text{chi22}}',
                   lhablock = 'NPINPUTS',
                   lhacode = [ 8 ])
...
ychi00 = Parameter(name = 'ychi00',
                   nature = 'external',
                   type = 'real',
                   value = 1.,
                   texname = 'y_{\\text{chi00}}',
                   lhablock = 'NPINPUTS',
                   lhacode = [ 10 ])
