...
if __name__ == "__main__":
    ...
    ap.add_argument('-p', '--parfile', default='parameters_mg5Pythia8.ini',
            help='path to the parameters file [parameters_mg5Pythia8.ini].')
    ...
    PYTHONPATH = subprocess.check_output('echo $PYTHONPATH',shell=True,text=True)
    lhapdfDir = os.path.abspath('./MG5/HEPTools/lhapdf6_py3/local/lib/python3.12/dist-packages')
    if pythiaDir not in LDPATH or lhapdfDir not in PYTHONPATH:
